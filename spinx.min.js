function combineSpinXWheelData(t,o){var e=t.config.wheel||{};let i=(t,e)=>e<t?e:i(t,e-t);return{id:t.id,borderAround:{type:e.borderAround?.customized&&e.borderAround.type?e.borderAround.type:o?.borderAround?.type,color:e.borderAround?.customized&&e.borderAround.color?e.borderAround.color:o?.borderAround?.color},prizeBorder:{displayed:e.prizeBorder?.customized?e.prizeBorder.displayed:o?.prizeBorder?.displayed,color:e.prizeBorder?.customized&&e.prizeBorder.color?e.prizeBorder.color:o?.prizeBorder?.color},circleCenter:{displayed:e.circleCenter?.customized?e.circleCenter.displayed:o?.circleCenter?.displayed,borderType:e.circleCenter?.customized&&e.circleCenter.borderType?e.circleCenter.borderType:o?.circleCenter?.borderType,borderColor:e.circleCenter?.customized&&e.circleCenter.borderColor?e.circleCenter.borderColor:o?.circleCenter?.borderColor,backgroundColor:e.circleCenter?.customized&&e.circleCenter.backgroundColor?e.circleCenter.backgroundColor:o?.circleCenter?.backgroundColor,icon:e.circleCenter?.customized&&e.circleCenter.icon?e.circleCenter.icon:o?.circleCenter?.icon},sticker:{borderType:e.sticker?.customized&&e.sticker.borderType?e.sticker.borderType:o?.sticker?.borderType,borderColor:e.sticker?.customized&&e.sticker.borderColor?e.sticker.borderColor:o?.sticker?.borderColor,backgroundColor:e.sticker?.customized&&e.sticker.backgroundColor?e.sticker.backgroundColor:o?.sticker?.backgroundColor},playingMusic:e.playingMusic,prizes:t.prizes?.map((t,e)=>{var n=t.config,e=o.prizes?.length?o.prizes[i(o.prizes?.length||0,e)]:null;return{id:t.id,name:t.name,type:t.type,status:t.status,order:t.order,config:{discount:n.discount,freeShipping:n.freeShipping,fontFamily:n.fontFamily?.customized&&n.fontFamily.value?n.fontFamily.value:e?.fontFamily,fontSize:n.fontSize?.customized&&n.fontSize.value?n.fontSize.value:e?.fontSize,contentColor:n.contentColor?.customized&&n.contentColor.value?n.contentColor.value:e?.contentColor,backgroundColor:n.backgroundColor?.customized&&n.backgroundColor.value?n.backgroundColor.value:e?.backgroundColor,effectMusic:n.effectMusic}}})}}function combineSpinXFormLoginRequiredData(t,e){var n=t.config.form||{};return{id:t.id,showLogo:n.showLogo,title:n.title?.customized&&n.title.value?n.title.value:e?.title,description:n.description?.customized&&n.description.value?n.description.value:e?.description,fontFamily:n.fontFamily?.customized&&n.fontFamily.value?n.fontFamily.value:e?.fontFamily,titleColor:n.titleColor?.customized&&n.titleColor.value?n.titleColor.value:e?.titleColor,contentColor:n.contentColor?.customized&&n.contentColor.value?n.contentColor.value:e?.contentColor,styleContent:n.styleContent?.customized&&n.styleContent.value?n.styleContent.value:""}}function combineSpinXPopupData(t,e){var n=t.config.popup||{};return{id:t.id,displayType:n.displayType,background:{backgroundColor:n.background?.customized&&n.background.backgroundColor?n.background.backgroundColor:e?.background?.backgroundColor,backgroundImage:n.background?.customized&&n.background.backgroundImage?.url?n.background.backgroundImage.url:e?.background?.backgroundImage,mobileBackgroundImage:n.background?.customized&&n.background.mobileBackgroundImage?.url?n.background.mobileBackgroundImage.url:e?.background?.mobileBackgroundImage},backgroundMusic:n.backgroundMusic,styleContent:n.styleContent?.customized&&n.styleContent.value?n.styleContent.value:""}}function combineSpinXOpenerData(t,e){var n=t.config.triggers.spinWheelOpener;return{id:t.id,content:n.content?.customized&&n.content.value?n.content.value:e?.content,position:n.position,distance:{bottom:n.distance?.bottom?.customized&&n.distance?.bottom?.value?n.distance?.bottom?.value:e?.distance?.bottom,left:n.distance?.left?.customized&&n.distance?.left?.value?n.distance?.left?.value:e?.distance?.left,right:n.distance?.right?.customized&&n.distance?.right?.value?n.distance?.right?.value:e?.distance?.right},contentColor:n.contentColor?.customized&&n.contentColor.value?n.contentColor.value:e?.contentColor,backgroundColor:n.backgroundColor?.customized&&n.backgroundColor.value?n.backgroundColor.value:e?.backgroundColor,wheelIcon:`assets/images/opener/${t.config.theme}.png`,attentionEffect:n.attentionEffect}}function combineSpinXAnnouncementData(t,e){var n=t.config.announcements,o={...n.upcomingEvent||{},content:n.upcomingEvent?.content||e?.upcomingEvent?.content},i={...n.readyToSpin||{},content:n.readyToSpin?.content||e?.readyToSpin?.content},a={...n.useWinningPrizes||{},content:n.useWinningPrizes?.content||e?.useWinningPrizes?.content},s={...n.getSpinByOrdering||{},content:n.getSpinByOrdering?.content||e?.getSpinByOrdering?.content,orderAmountRestriction:{content:n.getSpinByOrdering?.orderAmountRestriction?.content||e?.getSpinByOrdering?.orderAmountRestriction?.content}},r={...n.readyToSpinAgain||{},content:n.readyToSpinAgain?.content||e?.readyToSpinAgain?.content},d={...n.countDownToLaunch||{},content:n.countDownToLaunch?.content||e?.countDownToLaunch?.content},c={...n.countDownToClose||{},content:n.countDownToClose?.content||e?.countDownToClose?.content};return{id:t.id,status:t.status,scheduledAt:t.scheduledAt&&"string"==typeof t.scheduledAt?new Date(t.scheduledAt):t.scheduledAt,launchedAt:t.launchedAt&&"string"==typeof t.launchedAt?new Date(t.launchedAt):t.launchedAt,closedAt:t.closedAt&&"string"==typeof t.closedAt?new Date(t.closedAt):t.closedAt,position:n.position,displayType:n.displayType,fontFamily:n.fontFamily?.customized&&n.fontFamily.value?n.fontFamily.value:e?.fontFamily,contentColor:n.contentColor?.customized&&n.contentColor.value?n.contentColor.value:e?.contentColor,backgroundColor:n.backgroundColor?.customized&&n.backgroundColor.value?n.backgroundColor.value:e?.backgroundColor,styleContent:n.styleContent?.customized&&n.styleContent.value?n.styleContent.value:"",upcomingEvent:o,readyToSpin:i,useWinningPrizes:a,getSpinByOrdering:s,readyToSpinAgain:r,countDownToLaunch:d,countDownToClose:c,attentionEffect:n.attentionEffect}}function readSpinXJson(t){return fetch(t).then(t=>{if(t.ok)return t.json();throw new Error("HTTP error "+t.status)}).catch(function(){this.dataError=!0})}function convertSpinXCurrency(t,e="USD",n){return t.toLocaleString(n?.locales,{style:"currency",currency:e,currencyDisplay:n?.currencyDisplay})}function formatSpinXDateTime(t){return"[object Date]"!==Object.prototype.toString.call(t)?"NaD":dayjs(t).format("DD/MM/YYYY HH:mm")}function lessThanSpinXHours(t,e,n){return 0<t.getTime()-e.getTime()&&(t.getTime()-e.getTime())/36e5<n}function lessThanSpinXDays(t,e,n){return 0<t.getTime()-e.getTime()&&(t.getTime()-e.getTime())/864e5<n}function convertSpinXCountDownTime(t){var e=t%3600;return Math.floor(t/3600)+`:${Math.floor(e/60)}:`+Math.floor(e%60)}class SpinXAnnouncement extends HTMLElement{data;constructor(){super(),this.attachShadow({mode:"open"}),this.countDownId="spinx-count-down",this.messageItemClass="announcement-item"}connectedCallback(){this.render(),this.dispatchEvent(new CustomEvent("onLoadedAnnouncement",{bubbles:!0,composed:!0}))}render(){this.data=JSON.parse(this.dataset.json),this.data.scheduledAt&&"string"==typeof this.data.scheduledAt&&(this.data.scheduledAt=new Date(this.data.scheduledAt)),this.data.launchedAt&&"string"==typeof this.data.launchedAt&&(this.data.launchedAt=new Date(this.data.launchedAt)),this.data.closedAt&&"string"==typeof this.data.closedAt&&(this.data.closedAt=new Date(this.data.closedAt));var t,n=[];if("upcoming_event"===this.data.spinState?.state)if(this.data.countDownToLaunch?.enabled&&this.data.countDownToLaunch.content&&this.data.countDownToLaunch.displayHours&&lessThanSpinXHours(this.data.launchedAt,new Date,this.data.countDownToLaunch.displayHours)){let e=()=>(this.data.launchedAt.getTime()-(new Date).getTime())/1e3;setInterval(()=>{var t=this.shadowRoot.getElementById(this.countDownId);t&&(t.innerHTML=this.data.countDownToLaunch.content.replace(/{{TIME}}/g,convertSpinXCountDownTime(e())))},1e3),n.push(`<p class="${this.messageItemClass}" id="${this.countDownId}">${this.data.countDownToLaunch.content.replace(/{{TIME}}/g,convertSpinXCountDownTime(e()))}</p>`)}else this.data.upcomingEvent?.enabled&&this.data.upcomingEvent.content&&this.data.upcomingEvent.displayDays&&lessThanSpinXDays(this.data.launchedAt,new Date,this.data.upcomingEvent.displayDays)&&n.push(`<p class="${this.messageItemClass}">${this.data.upcomingEvent.content.replace(/{{TIME}}/g,formatSpinXDateTime(this.data.launchedAt))}</p>`);else if(["ready_to_spin","use_winning_prizes","get_spin_by_ordering","ready_to_spin_again"].includes(this.data.spinState?.state))if(this.data.countDownToClose?.enabled&&this.data.countDownToClose.content&&this.data.countDownToClose.displayHours&&lessThanSpinXHours(this.data.closedAt,new Date,this.data.countDownToClose.displayHours)){let e=()=>(this.data.closedAt.getTime()-(new Date).getTime())/1e3;setInterval(()=>{var t=this.shadowRoot.getElementById(this.countDownId);t&&(t.innerHTML=this.data.countDownToClose.content.replace(/{{TIME}}/g,convertSpinXCountDownTime(e())))},1e3),n.push(`<p class="${this.messageItemClass}" id="${this.countDownId}">${this.data.countDownToClose.content.replace(/{{TIME}}/g,convertSpinXCountDownTime(e()))}</p>`)}else"ready_to_spin"===this.data.spinState?.state?this.data.readyToSpin?.enabled&&this.data.readyToSpin.content&&(t=`<img class="spinx-icon-announcement" src="${this.data.spinState.spinIcon}" />`,n.push(`<p class="${this.messageItemClass}">${this.data.readyToSpin.content.replace(/{{SPIN}}/g,t)}</p>`)):"use_winning_prizes"===this.data.spinState?.state?this.data.useWinningPrizes?.enabled&&this.data.useWinningPrizes.content&&n.push(`<p class="${this.messageItemClass}">${this.data.useWinningPrizes.content.replace(/{{CODE}}/g,this.data.spinState?.productCode)}</p>`):"get_spin_by_ordering"===this.data.spinState?.state?this.data.getSpinByOrdering?.enabled&&(this.data.getSpinByOrdering.orderAmountRestriction?.enabled?this.data.getSpinByOrdering.orderAmountRestriction.content&&this.data.getSpinByOrdering.orderAmountRestriction.amount?.value&&this.data.getSpinByOrdering.orderAmountRestriction.amount?.currency&&(t=convertSpinXCurrency(this.data.getSpinByOrdering.orderAmountRestriction.amount.value,this.data.getSpinByOrdering.orderAmountRestriction.amount.currency),n.push(`<p class="${this.messageItemClass}">${this.data.getSpinByOrdering.orderAmountRestriction.content.replace(/{{AMOUNT}}/g,t)}</p>`)):this.data.getSpinByOrdering.content&&n.push(`<p class="${this.messageItemClass}">${this.data.getSpinByOrdering.content}</p>`)):"ready_to_spin_again"===this.data.spinState?.state&&this.data.readyToSpinAgain?.enabled&&this.data.readyToSpinAgain.content&&(t=`<img class="spinx-icon-announcement" src="${this.data.readyToSpinAgain.spinIcon}" />`,n.push(`<p class="${this.messageItemClass}">${this.data.readyToSpinAgain.content.replace(/{{SPIN}}/g,t)}</p>`));let e="",o=(n.forEach(t=>{e+=t}),this.data?.attentionEffect.enabled&&this.data?.attentionEffect.intervalTime?this.data?.attentionEffect.intervalTime:3),i="";n.forEach((t,e)=>{i+=`.spinx-announcement-container .${this.messageItemClass}:nth-child(${e+1}) { animation-delay: ${e*o}s; } `}),this.shadowRoot.innerHTML=`
    ...
    `,this.shadowRoot.querySelector(".close-button").addEventListener("click",()=>this.close())}get isOpened(){return this.shadowRoot.getElementById("popup-overlay").classList.contains("active")}setSpinContent(t){this.shadowRoot.querySelector(".spin-column").replaceChildren(t)}setFormContent(t){this.shadowRoot.querySelector(".info-column").replaceChildren(t)}open(t){var e=this.shadowRoot.getElementById("popup-overlay");e.classList.remove("fullscreen","halfscreen"),e.classList.add(!0===t||"full_screen"===this.data.displayType?"fullscreen":"halfscreen"),e.classList.add("active")}close(){this.shadowRoot.getElementById("popup-overlay").classList.remove("active")}}customElements.define("spinx-popup",SpinXPopup);class SpinXWheel extends HTMLElement{data;constructor(){super(),this.attachShadow({mode:"open"}),this.init()}connectedCallback(){this.render(),this.dispatchEvent(new CustomEvent("onLoadedWheel",{bubbles:!0,composed:!0}))}init(){this.width=this.getAttribute("width")||800,this.height=this.getAttribute("height")||800,this.stickerAngle=45,this.angleOffset=0,this.isSpinning=!1,this.isSpinningClass="is-spinning",this.tickerAnim,this.currentSlice=0}render(){this.data=JSON.parse(this.dataset.json),this.prizeAngle=this.data.prizes?.length?360/this.data.prizes?.length:0,this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: flex;
          align-items: center;
