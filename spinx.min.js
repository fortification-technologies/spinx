class SpinXAnnouncement extends HTMLElement{data;constructor(){super(),this.attachShadow({mode:"open"}),this.countDownId="spinx-count-down",this.messageItemClass="announcement-item"}connectedCallback(){this.render(),this.dispatchEvent(new CustomEvent("onLoadedAnnouncement",{bubbles:!0,composed:!0}))}render(){this.data=JSON.parse(this.dataset.json),this.data.scheduledAt&&"string"==typeof this.data.scheduledAt&&(this.data.scheduledAt=new Date(this.data.scheduledAt)),this.data.launchedAt&&"string"==typeof this.data.launchedAt&&(this.data.launchedAt=new Date(this.data.launchedAt)),this.data.closedAt&&"string"==typeof this.data.closedAt&&(this.data.closedAt=new Date(this.data.closedAt));var t,n=[];if("upcoming_event"===this.data.spinState?.state)if(this.data.countDownToLaunch?.enabled&&this.data.countDownToLaunch.content&&this.data.countDownToLaunch.displayHours&&lessThanSpinXHours(this.data.launchedAt,new Date,this.data.countDownToLaunch.displayHours)){let e=()=>(this.data.launchedAt.getTime()-(new Date).getTime())/1e3;setInterval(()=>{var t=this.shadowRoot.getElementById(this.countDownId);t&&(t.innerHTML=this.data.countDownToLaunch.content.replace(/{{TIME}}/g,convertSpinXCountDownTime(e())))},1e3),n.push(`<p class="${this.messageItemClass}" id="${this.countDownId}">${this.data.countDownToLaunch.content.replace(/{{TIME}}/g,convertSpinXCountDownTime(e()))}</p>`)}else this.data.upcomingEvent?.enabled&&this.data.upcomingEvent.content&&this.data.upcomingEvent.displayDays&&lessThanSpinXDays(this.data.launchedAt,new Date,this.data.upcomingEvent.displayDays)&&n.push(`<p class="${this.messageItemClass}">${this.data.upcomingEvent.content.replace(/{{TIME}}/g,formatSpinXDateTime(this.data.launchedAt))}</p>`);else if(["ready_to_spin","use_winning_prizes","get_spin_by_ordering","ready_to_spin_again"].includes(this.data.spinState?.state))if(this.data.countDownToClose?.enabled&&this.data.countDownToClose.content&&this.data.countDownToClose.displayHours&&lessThanSpinXHours(this.data.closedAt,new Date,this.data.countDownToClose.displayHours)){let e=()=>(this.data.closedAt.getTime()-(new Date).getTime())/1e3;setInterval(()=>{var t=this.shadowRoot.getElementById(this.countDownId);t&&(t.innerHTML=this.data.countDownToClose.content.replace(/{{TIME}}/g,convertSpinXCountDownTime(e())))},1e3),n.push(`<p class="${this.messageItemClass}" id="${this.countDownId}">${this.data.countDownToClose.content.replace(/{{TIME}}/g,convertSpinXCountDownTime(e()))}</p>`)}else"ready_to_spin"===this.data.spinState?.state?this.data.readyToSpin?.enabled&&this.data.readyToSpin.content&&(t=`<img class="spinx-icon-announcement" src="${this.data.spinState.spinIcon}" />`,n.push(`<p class="${this.messageItemClass}">${this.data.readyToSpin.content.replace(/{{SPIN}}/g,t)}</p>`)):"use_winning_prizes"===this.data.spinState?.state?this.data.useWinningPrizes?.enabled&&this.data.useWinningPrizes.content&&n.push(`<p class="${this.messageItemClass}">${this.data.useWinningPrizes.content.replace(/{{CODE}}/g,this.data.spinState?.productCode)}</p>`):"get_spin_by_ordering"===this.data.spinState?.state?this.data.getSpinByOrdering?.enabled&&(this.data.getSpinByOrdering.orderAmountRestriction?.enabled?this.data.getSpinByOrdering.orderAmountRestriction.content&&this.data.getSpinByOrdering.orderAmountRestriction.amount?.value&&this.data.getSpinByOrdering.orderAmountRestriction.amount?.currency&&(t=convertSpinXCurrency(this.data.getSpinByOrdering.orderAmountRestriction.amount.value,this.data.getSpinByOrdering.orderAmountRestriction.amount.currency),n.push(`<p class="${this.messageItemClass}">${this.data.getSpinByOrdering.orderAmountRestriction.content.replace(/{{AMOUNT}}/g,t)}</p>`)):this.data.getSpinByOrdering.content&&n.push(`<p class="${this.messageItemClass}">${this.data.getSpinByOrdering.content}</p>`)):"ready_to_spin_again"===this.data.spinState?.state&&this.data.readyToSpinAgain?.enabled&&this.data.readyToSpinAgain.content&&(t=`<img class="spinx-icon-announcement" src="${this.data.readyToSpinAgain.spinIcon}" />`,n.push(`<p class="${this.messageItemClass}">${this.data.readyToSpinAgain.content.replace(/{{SPIN}}/g,t)}</p>`));let e="",o=(n.forEach(t=>{e+=t}),"");n.forEach((t,e)=>{o+=`.spinx-announcement-container .${this.messageItemClass}:nth-child(${e+1}) { animation-delay: ${3*e}s; } `}),this.shadowRoot.innerHTML=`
    ...
    `,this.container.append(this.wheel,this.circle,this.ticker)}darkenHex(t,e){t=parseInt(t.slice(1),16);return"#"+(Math.max(0,(t>>16)-e)<<16|Math.max(0,(t>>8&255)-e)<<8|Math.max(0,(255&t)-e)).toString(16).padStart(6,"0")}renderWheelCanvas(){let n=this.wheel.getContext("2d"),o=this.width/2,i=2*Math.PI/this.data.prizes.length;n.clearRect(0,0,this.width,this.height),"standard"===this.data.borderDisplayType.type&&(n.beginPath(),n.arc(o,o,o-10,0,2*Math.PI),n.lineWidth=10,n.strokeStyle=this.data.borderDisplayType.color||"#FFFFFF",n.stroke()),this.data.prizes.forEach((t,e)=>{"auto_darken"===this.data.borderDisplayType.type&&(n.beginPath(),n.moveTo(o,o),n.arc(o,o,o,i*e+this.angleOffset,i*(e+1)+this.angleOffset),n.closePath(),n.fillStyle=this.darkenHex(t.config.backgroundColor,20),n.fill()),n.beginPath(),n.moveTo(o,o),n.arc(o,o,o-13,i*e+this.angleOffset,i*(e+1)+this.angleOffset),n.closePath(),n.fillStyle=t.config.backgroundColor,n.fill(),"standard"===this.data.borderDisplayType.type&&(n.strokeStyle="#ffffff",n.lineWidth=2,n.stroke()),n.save(),n.translate(o,o),n.rotate(i*e+i/2+this.angleOffset),n.textAlign="center",n.fillStyle=t.config.contentColor||"#ffffff",n.font=`bold ${t.config.fontSize||"32px"} `+(t.config.fontFamily||"Arial"),n.fillText(t.name,o/1.4,10),n.restore()}),this.wheel.style.transform="rotate(0deg)",this.wheel.style.transition="transform 15s cubic-bezier(0.20, 0.1, 0.20, 1)",this.wheel.addEventListener("transitionend",this.onTransitionend.bind(this))}renderCircleCanvas(){var t=this.circle.getContext("2d"),e=this.width/2;t.clearRect(0,0,this.width,this.height),t.beginPath(),t.arc(e,e,e/6,0,2*Math.PI),t.fillStyle=this.data.circleColor||"#FFD700",t.fill(),"standard"===this.data.borderDisplayType.type&&(t.lineWidth=5,t.strokeStyle=this.data.borderDisplayType.color||"#FFFFFF",t.stroke())}spin(e){if(!this.isSpinning){this.isSpinning=!0,this.dispatchEvent(new CustomEvent("onStartSpin",{bubbles:!0,composed:!0})),this.container.classList.add(this.isSpinningClass),this.ticker.style.animation="none",this.runTickerAnimation();var n=e*this.prizeAngle,e=(e+1)*this.prizeAngle;let t=Math.round(Math.random()*(e-n)+n);0!==t&&t%this.prizeAngle!=0||t--;e=3600-t-45;this.wheel.style.transform=`rotate(${e}deg)`}}onTransitionend(){cancelAnimationFrame(this.tickerAnim),this.isSpinning=!1,this.container.classList.remove(this.isSpinningClass),this.dispatchEvent(new CustomEvent("onEndSpin",{bubbles:!0,composed:!0}))}runTickerAnimation=()=>{var t=window.getComputedStyle(this.wheel).transform.split("(")[1].split(")")[0].split(","),e=t[0];let n=Math.atan2(t[1],e);n<0&&(n+=2*Math.PI);t=Math.round(n*(180/Math.PI)),e=Math.floor((t+45)/this.prizeAngle);this.currentSlice!==e&&(this.ticker.style.animation="none",setTimeout(()=>this.ticker.style.animation=null,10),this.currentSlice=e),this.tickerAnim=requestAnimationFrame(this.runTickerAnimation.bind(this))}}customElements.define("spinx-wheel",SpinXWheel);class SpinXForm extends HTMLElement{data;constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.dispatchEvent(new CustomEvent("onLoadedForm",{bubbles:!0,composed:!0}))}render(){this.data=JSON.parse(this.dataset.json),this.shadowRoot.innerHTML=`
      <style>
        :host {
    ...
    `,this.shadowRoot.getElementById("spin-button").addEventListener("click",()=>this.dispatchEvent(new CustomEvent("onSpin",{bubbles:!0,composed:!0})))}}function combineSpinXWheelData(t,o){var e=t.config;let i=(t,e)=>e<t?e:i(t,e-t);return{id:t.id,borderDisplayType:{type:(e.borderDisplayType?.customized&&e.borderDisplayType.value?.type?e.borderDisplayType.value:o?.borderDisplayType)?.type,color:(e.borderDisplayType?.customized&&e.borderDisplayType.value?.color?e.borderDisplayType.value:o?.borderDisplayType)?.color},circleColor:e.circleColor?.customized&&e.circleColor.value?e.circleColor.value:o?.circleColor,playingMusic:e.playingMusic,prizes:t.prizes?.map((t,e)=>{var n=t.config,e=o.prizes?.length?o.prizes[i(o.prizes.length,e)]:null;return{id:t.id,name:t.name,type:t.type,status:t.status,order:t.order,config:{discount:n.discount,freeShipping:n.freeShipping,fontFamily:n.fontFamily?.customized&&n.fontFamily.value?n.fontFamily.value:e?.fontFamily,fontSize:n.fontSize?.customized&&n.fontSize.value?n.fontSize.value:e?.fontSize,contentColor:n.contentColor?.customized&&n.contentColor.value?n.contentColor.value:e?.contentColor,backgroundColor:n.backgroundColor?.customized&&n.backgroundColor.value?n.backgroundColor.value:e?.backgroundColor,effectMusic:n.effectMusic}}})}}function combineSpinXFormData(t,e){var n=t.config;return{id:t.id,showLogo:n.showLogo,title:n.title?.customized&&n.title.value?n.title.value:e?.title,description:n.description?.customized&&n.description.value?n.description.value:e?.description,fontFamily:n.fontFamily?.customized&&n.fontFamily.value?n.fontFamily.value:e?.fontFamily,titleColor:n.titleColor?.customized&&n.titleColor.value?n.titleColor.value:e?.titleColor,contentColor:n.contentColor?.customized&&n.contentColor.value?n.contentColor.value:e?.contentColor}}function combineSpinXPopupData(t,e){var n=t.config;return{id:t.id,usePopupFullScreen:n.usePopupFullScreen,backgroundColor:n.backgroundColor?.customized&&n.backgroundColor.value?n.backgroundColor.value:e?.backgroundColor,backgroundImage:n.backgroundImage?.customized&&n.backgroundImage.value?.url?n.backgroundImage.value.url:e?.backgroundImage,mobileBackgroundImage:n.mobileBackgroundImage?.customized&&n.mobileBackgroundImage.value?.url?n.mobileBackgroundImage.value.url:e?.mobileBackgroundImage,styleContent:n.styleContent?.customized&&n.styleContent.value?n.styleContent.value:"",backgroundMusic:n.backgroundMusic}}function combineSpinXOpenerData(t,e){var n=t.config.triggers.spinWheelOpener;return{id:t.id,content:n.content?.customized&&n.content.value?n.content.value:e?.content,position:n.position,distance:{bottom:n.distance?.bottom?.customized&&n.distance?.bottom?.value?n.distance?.bottom?.value:e?.distance?.bottom,left:n.distance?.left?.customized&&n.distance?.left?.value?n.distance?.left?.value:e?.distance?.left,right:n.distance?.right?.customized&&n.distance?.right?.value?n.distance?.right?.value:e?.distance?.right},contentColor:n.contentColor?.customized&&n.contentColor.value?n.contentColor.value:e?.contentColor,backgroundColor:n.backgroundColor?.customized&&n.backgroundColor.value?n.backgroundColor.value:e?.backgroundColor,attentionEffect:n.attentionEffect}}function combineSpinXAnnouncementData(t,e){var n=t.config.announcements,o={...n.upcomingEvent||{},content:n.upcomingEvent?.content||e?.upcomingEvent?.content},i={...n.readyToSpin||{},content:n.readyToSpin?.content||e?.readyToSpin?.content},a={...n.useWinningPrizes||{},content:n.useWinningPrizes?.content||e?.useWinningPrizes?.content},s={...n.getSpinByOrdering||{},content:n.getSpinByOrdering?.content||e?.getSpinByOrdering?.content,orderAmountRestriction:{content:n.getSpinByOrdering?.orderAmountRestriction?.content||e?.getSpinByOrdering?.orderAmountRestriction?.content}},r={...n.readyToSpinAgain||{},content:n.readyToSpinAgain?.content||e?.readyToSpinAgain?.content},c={...n.countDownToLaunch||{},content:n.countDownToLaunch?.content||e?.countDownToLaunch?.content},d={...n.countDownToClose||{},content:n.countDownToClose?.content||e?.countDownToClose?.content};return{id:t.id,status:t.status,scheduledAt:t.scheduledAt&&"string"==typeof t.scheduledAt?new Date(t.scheduledAt):t.scheduledAt,launchedAt:t.launchedAt&&"string"==typeof t.launchedAt?new Date(t.launchedAt):t.launchedAt,closedAt:t.closedAt&&"string"==typeof t.closedAt?new Date(t.closedAt):t.closedAt,position:n.position,displayType:n.displayType,fontFamily:n.fontFamily?.customized&&n.fontFamily.value?n.fontFamily.value:e?.fontFamily,contentColor:n.contentColor?.customized&&n.contentColor.value?n.contentColor.value:e?.contentColor,backgroundColor:n.backgroundColor?.customized&&n.backgroundColor.value?n.backgroundColor.value:e?.backgroundColor,upcomingEvent:o,readyToSpin:i,useWinningPrizes:a,getSpinByOrdering:s,readyToSpinAgain:r,countDownToLaunch:c,countDownToClose:d,attentionEffect:n.attentionEffect}}function readSpinXJson(t){return fetch(t).then(t=>{if(t.ok)return t.json();throw new Error("HTTP error "+t.status)}).catch(function(){this.dataError=!0})}function convertSpinXCurrency(t,e="USD",n){return t.toLocaleString(n?.locales,{style:"currency",currency:e,currencyDisplay:n?.currencyDisplay})}function formatSpinXDateTime(t){return"[object Date]"!==Object.prototype.toString.call(t)?"NaD":`${t.getDate()}/${t.getMonth()+1}/${t.getFullYear()} ${t.getHours()}:`+t.getMinutes()}function lessThanSpinXHours(t,e,n){return 0<t.getTime()-e.getTime()&&(t.getTime()-e.getTime())/36e5<n}function lessThanSpinXDays(t,e,n){return 0<t.getTime()-e.getTime()&&(t.getTime()-e.getTime())/864e5<n}function convertSpinXCountDownTime(t){var e=t%3600;return Math.floor(t/3600)+`:${Math.floor(e/60)}:`+Math.floor(e%60)}customElements.define("spinx-form",SpinXForm),Date.prototype.addDays=function(t){return this.setTime(this.getTime()+24*t*60*60*1e3),this},Date.prototype.addHours=function(t){return this.setTime(this.getTime()+60*t*60*1e3),this},Date.prototype.addMinutes=function(t){return this.setTime(this.getTime()+60*m*1e3),this};